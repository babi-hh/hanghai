...
if($action=="add"){
    ...
    !empty($_POST['para98']) && $para98 = htmlentities(addslashes($_POST['para98']));
    !empty($_POST['para99']) && $para99 = htmlentities(addslashes($_POST['para99']));
    !empty($_POST['para100']) && $para100 = $_POST['para100'];
    !empty($_POST['para101']) && $para101 = $_POST['para101'];
    !empty($_POST['para102']) && $para102 = $_POST['para102'];
    !empty($_POST['para103']) && $para103 = $_POST['para103'];
	$fdok=false;
